...
| [CASES.md](CASES.md) | Case page visual system (inner-pages, slices, scroll, lightbox) |
...
| [../tasks/ROADMAP.md](../tasks/ROADMAP.md) | STEPs 1–19 Done; case redesign done; next = full route transition |
