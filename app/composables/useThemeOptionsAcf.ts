  ...
  return useAsyncData(
    ...
    },
    {
      ...
      getCachedData(key) {
        ...
        const fromPayload = nuxtApp.payload.data[key] as ThemeOptionsAcf | undefined;
        if (fromPayload) {
          state.value = fromPayload;
          return fromPayload;
        }
        const fromStatic = nuxtApp.static.data[key] as ThemeOptionsAcf | undefined;
        if (fromStatic) state.value = fromStatic;
        return fromStatic;
      },
    },
  );
